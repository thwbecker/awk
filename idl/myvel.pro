...
PRO MYVEL,U,W,x, y, LENGTH=length,XMAX=xmax, YMAX=ymax, nvecs = nvecs, nsteps = nsteps, $
...
if (!p.multi[1] eq 0) then begin
   ...
   plot,[0,XMAX, XMAX,0,0],[0,0,YMAX,YMAX, 0],title=title,pos=position, xtitle=xtitle, ytitle=ytitle
endif else BEGIN
   plot,[0,XMAX, XMAX,0,0],[0,0,YMAX, YMAX,0],title=title, xtitle=xtitle, ytitle=ytitle
endelse
FOR I=0,Nvecs-1 DO PLOTS,X[I,*,0]*XMAX,X[I,*,1]*YMAX
RETURN
end
