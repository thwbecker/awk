pro mk_image, a, WINDOW_SCALE = window_scale, ASPECT = aspect, $
	INTERP = interp, DOCONT = docont
;+
; NAME:
;	MK_IMAGE
;
...
;       This is a modified version of IMAGE_CONT, where it was impossible
;       to suppress the contour lines. (modified by Martin Knapmeyer, vii/93)
;       The contour lines are equidistant in the range between min(a) and
;       max(a), I hope.
;
; CATEGORY:
;	General graphics.
...
;	DMS, May, 1988.
;       Martin Knapmeyer 090793:  Keyword DOCONT added
;-
