pro pcgmt4,start,stop,range,pr,tlbs,tlbx,tlby,scaledtlbs
...
for nr=start,stop do begin
	...
	shade_surf,tlbs,150+tlbx*0.63,tlby*0.85,shade=bytscl(scaledtlbs),$
...
upper=500 & lower = 50
	...
	xyouts,120,970,"!4D!5Scher-Spannung",$
...
filename="coulomb"
	...
	shade_surf,clbs,150+clbx*0.63,clby*0.85,shade=bytscl(scaledclbs),$
		ax=90,az=0,xrange=[left,right],ystyle=4,xstyle=4,zstyle=4,$
		yrange=[left,right],/device
	...
	upper=700 & lower = 100
	xyouts,100,970,"!4D!5 Coulomb-Spannung (!4s!5-!4l!i!51!n!9.!4r!i!5n!n!5)",$
		charsize=2.0,color=textcolor

	step=1 & xu=550 & yu = 260 & len = 250
	...
	plot,tlb(0,*),tlb(2,*),yrange=[0,range*4],title="Scherspannung",$
		xtitle="x/m",ytitle="Pa",charsize=1.5
	plot,clb(0,*),clb(2,*),title="Coulombspannung",xtitle="x/m",charsize=1.5,$
		ytitle="Pa",yrange=[0,range*6]
