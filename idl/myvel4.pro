PRO MYVEL4,u, v, x, y, n, m, LENGTH=length, nvecs = nvecs, title = title,  $
...
IF (NOT overplot)THEN $
  plot, u, /nodata, xrange=[xmin, xmax], yrange=[ymin, ymax], $
  xtitle=xtitle, ytitle=ytitle, charsize = csz, title=title 
;;ELSE $
