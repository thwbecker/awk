...
pro myshow3, image, xc, yc, interp = interp, sscale=sscale, nameofgame ;Show an image three ways...
;+
; NAME:
;	SHOW3
;
...
;
; CALLING SEQUENCE:
;	MYSHOW3, mage, xc, yc, interp = interp, sscale=sscale, nameofgameImage [, INTERP = Interp, SSCALE = Sscale]
;
; INPUTS:
...
surface,img,/save,/nodata,xst=1,yst=1,zaxis=1, xticks=1,xtickname=[' ',' '], yticks=1,ytickname=[' ',' ']
...
surface,rebin(img,nx/sscale, ny/sscale),ztitle=nameofgame, $
	/save,/noerase,xst=4,yst=4, bot=128 ;Show the surface

			;And finally, draw contour on top

contour,img,xc, yc, /t3d,/noerase,zval=-1.0,xst=1,yst=1,c_color = c_color,/noclip, nlevels=29, xticks=0, yticks=0, $
  xtitle="x/a", ytitle="y/a", /nodata
contour,img,xc, yc, /t3d,/noerase,zval=1.0,xst=1,yst=1,c_color = c_color,/noclip, nlevels=29, xticks=0, yticks=0, $
  xtitle="x/a", ytitle="y/a"


;contour,img,/t3d,/noerase,zval=1.0,xst=1,yst=1,c_color = c_color,/noclip, nlevels=29
end
