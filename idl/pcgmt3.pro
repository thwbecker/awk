pro pcgmt3,start,stop,range,pr,tlbs,tlbx,tlby,scaledtlbs
...
filedir="/datdyn/becker/finel/model_single_crack_iterate/"
close, 1
time=dblarr(1)
set_plot,dev
...
filename="coulomb"
	...
	shade_surf,clbs,clbx,clby,shade=bytscl(scaledclbs),$
		...
		yrange=[left,right],/device
;		shade_surf,clbs,clbx,clby,shade=bytscl(scaledclbs),$
;		ax=90,az=0,ystyle=4,xstyle=4,zstyle=4
	...
	xyouts,xu+dx*5.0-100,yu+100*dy+130,"MPa",charsize=1.5,$
		color=textcolor,/device
