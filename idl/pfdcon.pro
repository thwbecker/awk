...
PRO pfdcon, startmodel, stopmodel, printing, printsingle
   on_error,2                   ;Return to caller if an error occurs
   ;; enter default model here
   if n_elements(startmodel) le 0 THEN startmodel = 1
   ...
   FOR model=startmodel, stopmodel DO begin 
       ...
       rayleighno = 0.12424E+08

       print, "# Using default rayleigh no of ", rayleighno

       OPENR, 1, dir+'time', ERROR = err
